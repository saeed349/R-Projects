...
upbound=list(theta1=10,theta2=10,theta3=10,theta4=10)
...
data.
```{r}
lookup.symb=c("TJX","DIS","HD","ROST","XLY")
...
# pmle_type=2
# fit_etf=Best.fit(data =stock2,pmle = pmle[pmle_type])
# print(paste("Best model = model ",fit_etf$best.model))
# # best_model[2]=fit2$best.model
...
D=setYuima(data=setData(as.double(etf_price)),model = model1)
initialise=list(theta1=0,theta2=0)
lowbound=list(theta1=-5,theta2=-5)
upbound=list(theta1=5,theta2=5)
mle=qmle(D,start=initialise,lower=lowbound,upper=upbound)
summary(mle)

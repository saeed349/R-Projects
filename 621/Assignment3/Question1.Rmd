...
print(paste("European Call Price=",Implicit(isCall=TRUE, K=100, Tm=1, S0=100, r=0.06, sig=0.25, N=as.integer(c[4]), Nj=as.integer(c[2]), div=0.03, dx=as.double(c[3]))$Price))
```
...
print(paste("For Explicit: Nj=",E[2]," dx=",E[3]," N=",E[4]))
E=QuestionE(error=0.001,Tm=1,nsd=6,isAmerican=FALSE,isCall=TRUE,isExplicit = FALSE,
            K=100, S0=100, r=0.06, sig=0.25, div=0.03)
print(paste("For Implicit: Nj=",E[2]," dx=",E[3]," N=",E[4]))
...
dsigma = .001* sigma
Vega = (Explicit(isCall=TRUE, K=100, Tm=1, S0=100, r=0.06, sig=sigma+dsigma, N=as.integer(c[4]), div=0.03, dx=as.double(c[3]))
-Explicit(isCall=TRUE, K=100, Tm=1, S0=100, r=0.06, sig=sigma-dsigma, N=as.integer(c[4]), div=0.03, dx=as.double(c[3])))/(2*dsigma)/100

explicit <- function(isCall, K, Tm,S0, r, sig, N, div, dx){
  ...
  for (i in N:1) {
    ...
    # DIDNT UNDERSTAND THIS ,Boundary Conditions ----
...
# explicit(isCall=TRUE, K=100, Tm=1,S0=100, r=0.06, sig=0.2,N=3, div=0.03, dx=0.2)

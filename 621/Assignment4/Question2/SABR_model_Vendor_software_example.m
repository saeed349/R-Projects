...
% oldMK    = xlsread('SABR vol surface from vendor.xls', 'Sheet1', 'C3:U3');
oldMV    = xlsread('swap_data.xlsx', 'Sheet1', 'C4:U4');
% oldMV    = xlsread('SABR vol surface from vendor.xls', 'Sheet1', 'C4:U9');
...
%Increment = 10;
MK2 = oldMK; %[oldMK(1):Increment:oldMK(end)];
